            ...
            <div className="custom-scrollbar  w-3/4 p-6 h-screen overflow-y-auto">
              <div className="mb-4 space-y-4">
                <p className="text-gray-500 mt-2 text-sm leading-6">
                  ...
                  comprehensive evaluations, diagnosis and treatment of various
                  speech, language, social communication,
                  cognitive-communication and swallowing disorders in children
                  and adults. When required our multi-disciplinary
                  rehabilitative team comes together to support our patrons. Our
                  expert Speech Language Pathologist offers appropriate
                  treatment protocols for various speech and language disorders
                  listed below in the comfort of your homes.
                </p>
              </div>
              ...
              <div className="py-6">
                ...
                <ul className="mt-3 flex flex-col space-y-2 text-gray-500">
                  ...
                  <li className="flex">
                    <LuCheckCircle2 className="mr-2 h-auto w-4 text-green-600 " />
                    <p className="text-base text-sm">
                      Comprehensive/formal/standardized speech and language
                  ...
                  <li className="flex">
                    <LuCheckCircle2 className="mr-2 h-auto w-4 text-green-600 " />
                    <p className="text-base text-sm">
                      Augmentative Alternative Communication/ tool/ computer
                      assisted therapy
                    </p>
                  </li>
                  <li className="flex">
