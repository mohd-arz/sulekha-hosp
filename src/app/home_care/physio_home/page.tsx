            ...
            <div className="custom-scrollbar  w-3/4 p-6 h-screen overflow-y-auto">
              <div className="mb-4 space-y-4">
                <p className="text-gray-500 mt-2 text-sm leading-6">
                  ...
                  effective treatment of injury, illness, or disability through
                  movement and exercise, manual therapy and education you will
                  be able to recover faster and get back to the activities you
                  enjoy. From pediatric to elderly care including people of
                  determination, Physiotherapy helps patients of all ages to
                  maintain their health, manage pain and prevent injury. Our
                  qualified physiotherapists can help you at your place of
                ...
                <ul className="  mt-4 text-gray-500 text-sm space-y-3">
                  <li className="flex">
                    ...
                    <p className="text-base  text-sm">
                      Neuro-muscular pain syndrome for Back, Neck, Shoulder,
                      Knee
                    </p>
                  </li>
                  <li className="flex">
