...
const psycology:  React.FC<{ toggleForm: () => void }> = ({ toggleForm }) => {
  return (
    <div className="p-4">
      <div className="mb-4 space-y-4">
        <p className="text-gray-500 mt-2 text-sm leading-6">
          Home-based therapy has helped many people improve their mental
          wellbeing in the comfort of their homes. Zulekha Home Care Services
          provide a comprehensive range of psychology services in a comfortable
          environment for the patient as well as the therapists, to be able to
          work on the treatment plan in an effective manner. Diagnosis and
          treatment of mental disorders is done using various
          psycho-pharmacological and psycho-therapeutic methods. The experts
          address a range of mental, emotional and behavioral problems including
        ...
        <ul className="mt-3 flex flex-col space-y-3 text-gray-500">
          ...
          <li className="flex">
            ...
            <p className="text-base  text-sm">
              ...
              Depression, Anxiety, ADHD, poor scholastic performance etc.
            </p>
          </li>
          <li className="flex">
            <LuCheckCircle2 className="mr-2 h-auto w-4 text-green-600 " />
