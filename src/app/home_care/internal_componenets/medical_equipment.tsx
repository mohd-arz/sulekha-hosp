...
const MedicalEquipment:  React.FC<{ toggleForm: () => void }> = ({ toggleForm }) => {
  return (
    <div className="p-4">
      <div className="mb-4 space-y-4">
        <p className="text-gray-500 mt-2 text-sm leading-6">
          We bring modern medical equipment and expertise to your home for
          continued compassionate care. Rent Medical Equipment so your loved
          ones can stay in the comfort of home with the best equipment right by
          their side.
        </p>
      </div>
      <div>
