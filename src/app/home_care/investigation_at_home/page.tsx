            ...
            <div className="custom-scrollbar  w-3/4 p-6 h-screen overflow-y-auto">
              <div className="mb-4 space-y-4">
                <p className="text-gray-500 mt-2 text-sm leading-6">
                  Zulekha HomeCare is equipped to send home health care
                  providers, healthcare specialists and technicians to conduct
                  investigations and collect lab samples from patients from
